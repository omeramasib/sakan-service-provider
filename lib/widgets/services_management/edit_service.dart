...
editService(BuildContext context) {
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  editServiceNameWidget(
                      context, controller, controller.getServices.serviceName!),
                  SizedBox(
                    height: 20,
                  ),
                  Row(
                  ...
                  editServicePriceWidget(
                    context,
                    controller,
                    controller.getServices.servicePrice.toString(),
                  ),
                  SizedBox(
                    height: 20,
                  ),
                  ...
                  editServiceDescriptionWidget(
                    context,
                    controller,
                    controller.getServices.serviceDescription!,
                  ),
                  SizedBox(
                    height: 10,
                  ),
                      ...
                      Row(
                        children: [
                          Padding(
                            ...
                            child: Obx(
                              () => Checkbox(
                                value: controller.isAvailable.value == true ||
                                    controller.getServices.isAvailable! == true,
